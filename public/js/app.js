...
$(document).ready(function() {
  ...
  $('form').submit(function(event){
    ...
    $.post('http://localhost:3000/api/albums', formData, function(album){
      renderAlbum(album);
    });
    $(this).trigger('reset');
  });
...
function getAlbums(){
  let myAlbums = $.get('http://localhost:3000/api/albums',function(albumList){
